(function(){
              try{if(!document.getElementById('dunta-native-fixes')){var s=document.createElement('style');s.id='dunta-native-fixes';s.textContent='html,body{width:100%!important;overflow-x:hidden!important}#dunta-driver-bar{position:fixed;left:12px;right:12px;bottom:18px;z-index:9999;background:#111;border:1px solid #333;border-radius:16px;padding:12px;display:none;color:#fff}#dunta-driver-bar.show{display:block}#dunta-driver-trip{position:fixed;left:12px;right:12px;top:64px;z-index:9998;background:#111827;border-radius:14px;padding:12px;color:#fff;display:none}#dunta-driver-trip.show{display:block}.driver-self-marker{width:42px;height:42px;border-radius:50%;background:#C10F06;border:3px solid #fff;display:grid;place-items:center}.driver-self-marker i{color:#FFD400}body.dunta-driver-mode #home .svc,body.dunta-driver-mode #home .search-box,body.dunta-driver-mode #home .search,body.dunta-driver-mode #btn-request,body.dunta-driver-mode #req,body.dunta-driver-mode .svc-card,body.dunta-driver-mode .where-to,body.dunta-driver-mode #go-btn{display:none!important;visibility:hidden!important;pointer-events:none!important}body.dunta-driver-mode #dunta-driver-bar{display:none!important}body.dunta-driver-mode .hh .brand:after{content:\' · Motorista\';font-size:11px;opacity:.7}';document.head.appendChild(s)}}catch(e){}
              ...
              function updUI(){
                try{
                  ...
                  try{if(typeof duntaApplyDriverMode==='function')duntaApplyDriverMode()}catch(e){}
                }catch(e){}
              }
              if(typeof requestRide==='function'&&!window.__duntaBlockRequest){
                window.__duntaBlockRequest=1;var _rr=requestRide;
                window.requestRide=function(){
                  try{var s=getSession&&getSession();if(s&&s.role==='driver'){if(typeof toast==='function')toast('Motoristas não pedem viagem');return}}catch(e){}
